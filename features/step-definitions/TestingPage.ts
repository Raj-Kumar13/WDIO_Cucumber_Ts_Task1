...
Then("should be navigated to WOMEN category page",async ()=>{
  await expect(WomenCategoryPage.womenHeaderElement).toBeDisplayed();     
})
...
Then("Should be navigated to SHOPPING-CART SUMMARY page", async ()=>{
     ...
     await expect(CartSummaryPage.summaryPageHeaderElement).toBeDisplayed()
...
Then("should be navigated to Address Page", async ()=>{
     await expect(AddressPage.AddressPageHeaderElement).toBeDisplayed()
})
...
Then("should be navigated to Shopping page", async ()=>{
  await expect(ShoppingPage.shoppingPageHeaderElement).toBeDisplayed()     
})
...
Then("should me navigate to ORDER SUMMARY", async ()=>{
     await expect(OrderSummaryPage.orderSummaryPageHeader).toBeDisplayed()
...
Then("You will navigated to ORDER CONFIRMATION DETAILS Page", async ()=>{
     await expect(OrderConfirmationPage.orderConfirmationHeaderElement).toBeDisplayed()
})
